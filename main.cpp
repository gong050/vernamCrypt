...
int main(int argc, const char * argv[])
{
    ...
    for(int i = 0; i < 10; i++)
    {
		...
		if(i == 0) cryptParametrs->downIndex = 0; else cryptParametrs->downIndex = inputSize / 10 * i;
        if(i == 9) cryptParametrs->topIndex = inputSize; else cryptParametrs->topIndex = inputSize / 10 * (i + 1);
